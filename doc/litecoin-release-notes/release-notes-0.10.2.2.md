Pigycoin Core version 0.10.2.2 is now available from:
...
- Pigycoin TCP port 7333 (instead of 8333)
- RPC TCP port 7332 (instead of 8332)
- Testnet TCP port 17333 (instead of 18333)
- Testnet RPC TCP port 17332 (instead of 18332)
...
- Bitcoin's IsDust() is disabled in favor of Pigycoin's fee-based dust penalty.
