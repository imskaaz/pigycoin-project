Pigycoin Core version *0.15.1* is now available from:

  <https://download.pigycoin.org/pigycoin-0.15.1/>
...
A number of changes to the way Pigycoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 pigyes per kB (0.00001 PIGY). This is to prepare for dropping the minimum transaction fee to 0.1 pigyes per kB (0.0001 PIGY) in the next release.
